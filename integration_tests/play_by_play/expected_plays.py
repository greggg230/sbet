...
expected_plays = [
    ...
    FieldGoalAttempt(play_length=2000, play_id=82, shot_made=True, points=2),
    FieldGoalAttempt(play_length=7000, play_id=83, shot_made=False, points=0),
    ...
    FieldGoalAttempt(play_length=0, play_id=93, shot_made=False, points=0),
    Rebound(play_length=1000, play_id=94, rebounding_player=Player("Ziaire Williams"), is_offensive=False),
    FieldGoalAttempt(play_length=9000, play_id=95, shot_made=False, points=0),
    ...
    FieldGoalAttempt(play_length=3000, play_id=98, shot_made=True, points=2),
    FieldGoalAttempt(play_length=19000, play_id=99, shot_made=False, points=0),
