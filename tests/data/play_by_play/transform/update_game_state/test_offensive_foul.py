...
from sbet.data.play_by_play.models.transform.fouls import OffensiveFoul
from sbet.data.play_by_play.update_game_state import update_game_state


class TestUpdateGameStateOffensiveFoul(unittest.TestCase):
    ...
    def test_offensive_foul(self):
        play = OffensiveFoul(play_length=2000, play_id=2, fouling_player=Player("H1"))
