...
from sbet.data.historical.models.csv import Team, Game as CsvGame, MoneyLineBettingOdds
...
class TestTransformToNbaMoneyLineBettingOpportunities(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.games: List[CsvGame] = [
            ...
            CsvGame(game_id=20800741, game_date='2009-02-06', matchup='ATL vs. BOS', team_id=1610612738, is_home=False,
                 ...
                 season='2008-09'),
            CsvGame(game_id=20800701, game_date='2009-01-31', matchup='BOS vs. ATL', team_id=1610612738, is_home=True,
                 wl='L',
                 ...
                 season='2008-09'),
            CsvGame(game_id=20800701, game_date='2009-01-31', matchup='BOS vs. ATL', team_id=1610612737, is_home=False,
                 wl='W',
                 w=26, l=22, w_pct=0.542, min=240, fgm=17.0, fga=36.0, fg_pct=0.472, fg3m=6.0, fg3a=15.0, fg3_pct=0.400,
                 ftm=14.0, fta=18.0, ft_pct=0.778, oreb=7.0, dreb=30.0, reb=37.0, ast=22.0, stl=6.0, blk=0.0, tov=15.0,
    ...
    def test_transform_to_nba_money_line_betting_opportunities(self):
        ...
        self.assertTrue(all(isinstance(opportunity, MoneyLineBettingOpportunity) for opportunity in opportunities))
